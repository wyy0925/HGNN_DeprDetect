...
#  Constructed based on https://github.com/xueyunlong12589/DGCNN
...
# 1-D CNN for EEG Temporal Feature Extraction
...
# Normalize the Adjacency Matrix in GNN
def normalize_A(A):
    A=F.relu(A)
    N=A.shape[0]
...
# Normalize the Adjcency Matrix in the form of batch (for IAGNN)
def BatchAdjNorm(A):
    bs,h, n, _ = A.shape
...
# Generate the adjacency matrix based on instance for IAGNN
...
# Generate the graph pooling and unpooling module(GPUM)
